...
internal class DivisionService constructor(
    ...
    override suspend fun getAllDivisions(lastId: Int, limit: Int, keyword: String): List<DivisionOverviewResponse> = safeRequest {
    ...
    override suspend fun getMyDivisions(lastId: Int, limit: Int, keyword: String): List<DivisionOverviewResponse> = safeRequest {
    ...
    override suspend fun getDivision(id: Int): DivisionInfoResponse = safeRequest {
        httpClient.get("${DodamUrl.DIVISION}/$id")
            .body<Response<DivisionInfoResponse>>()
    }

    override suspend fun getDivisionMembers(id: Int, status: String): List<DivisionMemberResponse> = safeRequest {
        httpClient.get("${DodamUrl.DIVISION}/$id/members") {
            parameter("status", status)
        }.body<Response<List<DivisionMemberResponse>>>()
    }

    override suspend fun getDivisionMembersCnt(id: Int, status: String): Int = safeRequest {
        httpClient.get("${DodamUrl.DIVISION}/$id/members/count") {
            parameter("status", status)
        }.body<Response<DivisionMemberCountResponse>>()
    }.count

    override suspend fun deleteDivision(divisionId: Int) = defaultSafeRequest {
        httpClient.delete("${DodamUrl.DIVISION}/$divisionId").body<DefaultResponse>()
    }

    override suspend fun deleteDivisionMembers(divisionId: Int, memberId: List<Int>) = defaultSafeRequest {
    ...
    override suspend fun postDivisionApplyRequest(divisionId: Int) = defaultSafeRequest {
        httpClient.post("${DodamUrl.DIVISION}/$divisionId/members/apply")
            .body<DefaultResponse>()
    }

    override suspend fun postDivisionAddMembers(divisionId: Int, memberId: List<String>) = defaultSafeRequest {
    ...
    override suspend fun postCreateDivision(name: String, description: String) = defaultSafeRequest {
    ...
    override suspend fun patchDivisionMembers(divisionId: Int, memberId: List<Int>, status: String) = defaultSafeRequest {
    ...
    override suspend fun patchDivisionMemberPermission(divisionId: Int, memberId: Int, permission: String) = defaultSafeRequest {
