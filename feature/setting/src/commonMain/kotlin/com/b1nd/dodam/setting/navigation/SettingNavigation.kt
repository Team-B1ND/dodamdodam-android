...
fun NavGraphBuilder.settingScreen(versionInfo: String, popBackStack: () -> Unit, logout: () -> Unit, navigationToEditMemberInfo: (profileImage: String?, name: String, email: String, phone: String) -> Unit) {
    composable(
        route = SETTING_ROUTE,
