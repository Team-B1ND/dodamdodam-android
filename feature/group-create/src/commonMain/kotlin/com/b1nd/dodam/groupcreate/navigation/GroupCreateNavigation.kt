...
fun NavController.navigateToGroupCreate(navOptions: NavOptions? = null) = navigate(GROUP_CREATE_ROUTE, navOptions)

fun NavGraphBuilder.groupCreateScreen(showSnackbar: (state: SnackbarState, message: String) -> Unit, popBackStack: () -> Unit) {
