...
import com.b1nd.dodam.busapply.model.BusApplyUiState
...
class BusApplyViewModel : ViewModel(), KoinComponent {

    private val busRepository: BusRepository by inject()

    private val _uiState = MutableStateFlow(BusApplyUiState())
