...
val DefaultProfile
    @Composable
    get() = imageResource(Res.drawable.ic_default_profile)

val BarChart
    @Composable
    get() = vectorResource(Res.drawable.ic_bar_chart)

val ColoredBus
    @Composable
    get() = vectorResource(Res.drawable.ic_colored_bus)

val ColoredCalendar
    @Composable
    get() = vectorResource(Res.drawable.ic_colored_calendar)

val ColoredMegaphone
    @Composable
    get() = vectorResource(Res.drawable.ic_colored_megaphone)

val ColoredMusicalNote
    @Composable
    get() = vectorResource(Res.drawable.ic_colored_musical_note)

val ColoredPencil
    @Composable
    get() = vectorResource(Res.drawable.ic_colored_pencil)
...
val ColoredExclamationMarkCircle
    @Composable
    get() = vectorResource(Res.drawable.ic_colored_exclamationmark_circle)

val ColoredXMarkCircle
    @Composable
    get() = vectorResource(Res.drawable.ic_colored_xmark_circle)
